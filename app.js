// --- API Configuration ---
const GEMINI_API_KEY = 'AIzaSyBwwUoUiZ-IVnCe8IAiGkbcZQki2AJAYMk';
...
class AppState {
    ...
    reset() {
        ...
        this.apiKey = GEMINI_API_KEY; // Keep API Key persistent
        this.questionCount = 3;
        this.quizQuestions = [];
        this.currentQIndex = 0;
        this.answers = {};
...
class QuizApp {
    ...
    async handleAnswerSubmit(userAnswer) {
        ...
        try {
            ...
            this.state.errorMsg = `حدث خطأ: ${err.message || "فشل الاتصال بـ Gemini API"}`;
        } finally {
    ...
    async evaluateAnswerWithGemini(apiKey, question, modelAnswer, userAnswer) {
